# import some portions of PyQt, OS, and other neccesary libraries
import sys
...
# Code that tells our program the location of the default image folder
...
## Finally we will initialize the main window of our desktop app.
class App(QWidget):
    def __init__(self):
        super().__init__()
...
## initializes a PyQt application object, which makes the main window.
